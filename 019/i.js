...
// 6. Sugeneruokite atsitiktinį skaičių nuo 0 iki 4. 
// Jeigu jis didesnis nei 2 atspauzdinkite 'DIDESNIS', kitu atveju 'MAZESNIS'
...
const person4 = {
    ...
    age: 25
                                    ...
                                    // Place the new person at the beginning of the people array
people.unshift(person4);

                                    // Print the updated people array
console.table(people);
...
const eggs = [];
                        ...
                        // Generate 10 random eggs with random colors
for (let i = 0; i < 10; i++) {
